...
def get_client(api_version, auth_type, service_type=SERVICE_TYPE, endpoint=None, **kwargs):
    ...
    if auth_type == KEYSTONE:
        ...
        return get_ks_client(api_version, auth_type, service_type, endpoint=endpoint, **kwargs)
        ...
        # token is provided, it'd better comes with endpoint, then no keystone catalog query needed
