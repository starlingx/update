...
def main():
    ...
    res = 0
    from_release_version = version.Version(from_release)
    from_version = version.Version("25.09")

    # Only remove service param on migrate from 25.09
    if action == 'migrate' and from_release_version == from_version:
        try:
